...
public class GuiManager implements RegisteredManager {
    ...
    public EnchantmentWrapper.Builder createEnchantmentBuilder() {
        return new EnchantmentWrapper.Builder();
    }
    ...
    public FunctionTree.Builder createFunctionTreeBuilder() {
        return new FunctionTree.Builder();
    }
