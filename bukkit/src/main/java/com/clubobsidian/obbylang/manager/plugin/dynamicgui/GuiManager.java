...
public class GuiManager implements RegisteredManager {
    ...
    private final Map<String, Value> functionScripts;
    ...
    private final Map<String, Value> replacerScripts;
    ...
    public void registerFunction(String declaringClass, String functionName, Value script) {
    ...
    public void registerReplacer(String declaringClass, String replacer, Value script) {
        this.init(declaringClass);
    ...
    public Value getScriptByFunctionName(String functionName) {
        return this.functionScripts.get(functionName);
    }

    public Context getFunctionOwner(String functionName) {
        String scriptName = this.functionScriptOwners.get(functionName);
        return ScriptManager.get().getScript(scriptName);
    }

    public Value getScriptByReplacerName(String replacerName) {
        return this.replacerScripts.get(replacerName);
    }

    public Context getReplacerOwner(String replacerName) {
