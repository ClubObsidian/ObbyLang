...
public class GuiManager implements RegisteredManager {
	...
	private Map<String, List<String>> functionStrings;
	private Map<String, ScriptObjectMirror> functionScripts;
	private Map<String, String> functionScriptOwners; //Key(FunctionName) Value(ScriptName)
	
	private Map<String, List<String>> replacerStrings;
	private Map<String, ScriptObjectMirror> replacerScripts;
	private Map<String, String> replacerScriptOwners; //Key(ReplacerName) Value(ScriptName)
