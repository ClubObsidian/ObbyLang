...
public class InstanceManager {
	...
	private Map<String, Instance> loadedInstances;
	private File permanentInstanceFolder;
	private File temporaryInstanceFolder;
	private File instanceTemplateFolder;
